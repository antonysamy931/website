<?php
	...
	$base_url = '/';
	$user_domain = 'technical-ant007.000webhostapp.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "pN6NI2Sq8KyJbl+yUUQ3o1ZgldSuO63Qhj2zXKypsgc2eA==";
	$user_hash = "1a5bced69c10f2e3";
